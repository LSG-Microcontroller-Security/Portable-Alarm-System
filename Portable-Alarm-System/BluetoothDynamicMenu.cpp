...
void BluetoothDynamicMenu::write_eeprom(
    uint8_t address,
    const char* value) {
...
bool BluetoothDynamicMenu::contains(
...
bool BluetoothDynamicMenu::read_value(
    const char* bluetooth_data,
    char* value,
    uint8_t capacity) {
    ...
    uint8_t value_length =
        static_cast<uint8_t>(value_end - value_start);
...
bool BluetoothDynamicMenu::copy_value(
    char* destination,
    uint8_t capacity,
    const char* value) {
...
BluetoothProgramText BluetoothDynamicMenu::calculate_battery_level(
    float battery_level) {
...
void BluetoothDynamicMenu::process() {
    ...
    if (bluetooth_repository.readString(
        bluetooth_data,
        sizeof(bluetooth_data)) == 0U) {
    ...
    if (contains(bluetooth_data, BT_TEXT("#0"))) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_phoneNumber, 11U, value)) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufDelayFindMe, 2U, value)) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufOffSetTemperature, 5U, value)) {

            write_eeprom(
                AddressOffsetTemperature,
                _bufOffSetTemperature);
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufDbPhoneON, 2U, value)) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufTemperatureMax, 3U, value)) {

            write_eeprom(
                AddressTemperatureMax,
                _bufTemperatureMax);
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufPirSensorIsON, 2U, value)) {

            write_eeprom(
                AddressPirSensorIsOn,
                _bufPirSensorIsON);

            _isPIRSensorActivated =
                atoi(_bufPirSensorIsON);
        }
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            copy_value(_bufDeviceAddress, 15U, value)) {

            write_eeprom(
                AddressDeviceAddress,
                _bufDeviceAddress);
        }
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            copy_value(_bufDeviceName, 15U, value)) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            copy_value(_bufDeviceAddress2, 15U, value)) {

            write_eeprom(
                AddressDeviceAddress2,
                _bufDeviceAddress2);
        }
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            copy_value(_bufDeviceName2, 15U, value)) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufFindOutPhonesON, 2U, value)) {

            write_eeprom(
                AddressFindOutPhonesOn,
                _bufFindOutPhonesON);

            _findOutPhonesMode =
                atoi(_bufFindOutPhonesON);

            _isBTSleepON =
                _findOutPhonesMode == 0U ? 1U : 0U;
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufExternalInterruptIsON, 2U, value)) {

            write_eeprom(
                AddressExternalInterruptIsOn,
                _bufExternalInterruptIsON);

            _isExternalInterruptOn =
                atoi(_bufExternalInterruptIsON);
        }
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            is_numeric(value) &&
            copy_value(_bufBuzzerIsON, 2U, value)) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            copy_value(_new_password, 5U, value)) {
        ...
        if (read_value(bluetooth_data, value, sizeof(value)) &&
            ...
            bluetooth_repository.set_password(
                _new_password);
